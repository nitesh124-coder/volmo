      ...
      <main className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">About VALMO</h2>
            <p className="text-xl text-gray-600">India's Leading Logistics Network</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            <div className="text-center p-6 bg-white rounded-lg shadow-lg">
              ...
              <p className="text-gray-600">Quick and reliable delivery services across India</p>
            </div>
            
            <div className="text-center p-6 bg-white rounded-lg shadow-lg">
              <div className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <i className="fas fa-network-wired text-2xl text-green-600"></i>
              </div>
              <h4 className="text-xl font-semibold text-gray-800 mb-3">Wide Network</h4>
              <p className="text-gray-600">Extensive network covering major cities and towns</p>
            </div>
            ...
            <div className="text-center p-6 bg-white rounded-lg shadow-lg">
              ...
              <h4 className="text-xl font-semibold text-gray-800 mb-3">Franchise Support</h4>
              <p className="text-gray-600">Complete support and training for franchise partners</p>
            </div>
          </div>
