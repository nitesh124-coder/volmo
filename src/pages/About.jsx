        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center mb-12 sm:mb-16">
            <div>
              ...
              <p className="text-gray-700 leading-relaxed mb-4 sm:mb-6 text-sm sm:text-base">
                VALMO is committed to revolutionizing India's logistics
                landscape by providing reliable, efficient, and cost-effective
                delivery solutions. We empower entrepreneurs through our
                comprehensive franchise model, creating opportunities for growth
                and success.
              </p>
              <p className="text-gray-700 leading-relaxed text-sm sm:text-base">
                Our network spans across major cities and towns, ensuring
                seamless connectivity and timely deliveries for businesses and
                individuals alike.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 mb-12 sm:mb-16">
            <div className="text-center p-4 sm:p-6 bg-white rounded-lg shadow-lg">
              ...
              <p className="text-gray-600 text-xs sm:text-sm">
                Quick and reliable delivery services across India
              </p>
            </div>
            ...
            <div className="text-center p-4 sm:p-6 bg-white rounded-lg shadow-lg md:col-span-1">
              ...
              <p className="text-gray-600 text-xs sm:text-sm">
                Complete support and training for franchise partners
              </p>
            </div>
          </div>
          ...
          <div className="bg-blue-50 rounded-lg p-6 sm:p-8 text-center">
            ...
            <p className="text-gray-700 mb-4 sm:mb-6 text-sm sm:text-base">
              Become a part of India's fastest-growing logistics franchise and
      ...
      <footer className="bg-gray-900 text-gray-300 py-6 sm:py-8">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xs sm:text-sm">
            © 2024 VALMO. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
