            ...
            <div className="text-center py-4">
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
                      ...
                      <p className="text-blue-600 text-xs sm:text-sm mt-1">
                        Your agent has assigned specific payment details for your application. 
                        Please use the bank details or QR code shown below to complete your payment.
                      </p>
                    </div>
                  )}
=======
...
<<<<<<< HEAD
                      ...
                      <p>
                        Branch: <strong>{applicationDetails.assignedBank.branchName}</strong>
                      </p>
                      <p>
                        A/C Holder:{" "}
                        <strong>{applicationDetails.assignedBank.accountHolderName}</strong>
                      </p>
                      <p>
                        A/C No.: <strong>{applicationDetails.assignedBank.accountNumber}</strong>
                      </p>
                      <p>
                        IFSC Code: <strong>{applicationDetails.assignedBank.ifscCode}</strong>
                      </p>
